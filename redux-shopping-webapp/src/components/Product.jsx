...
//     // Update handelFilter function
//     const handelFilter = () => {
//         let filteredProducts = [...defaultProducts];
//         if (filterValue.ratings.length > 0) {
//             filteredProducts = filteredProducts.filter(product => 
//                 filterValue.ratings.includes(Math.round(product.rating.rate))
//             );
//         }
...
//      // Update clickedFilter function
//      const clickedFilter = (category, isChecked) => {
//         setFilterValue(prev => {
...
//                 }
//             } else {
//                 newFilter.categories = newFilter.categories.filter(cat => cat !== category);
//             }
//             return newFilter;
//         });
//     };
...
//     const handleRatingFilter = (rating, isChecked) => {
//         setFilterValue(prev => {
//             const newFilter = { ...prev };
//             if (isChecked) {
//                 if (!newFilter.ratings.includes(rating)) {
//                     newFilter.ratings.push(rating);
//                 }
//             } else {
//                 newFilter.ratings = newFilter.ratings.filter(rate => rate !== rating);
//             }
//             return newFilter;
//         });
//     };
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="flex justify-start space-x-2">
                {/* SORT BUTTON */}
                <div className="mb-3 ml-1">
                    <button onClick={() => setIsOpenSort(!isOpenSort)} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white select-none bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Sort
                        <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    </button>
                ...
                <div className="mb-3 mr-1">
                    ...
                    {/* <!-- Dropdown menu --> */}
                    <div id="dropdown1" className={`z-10 ${isOpenFilter ? '' : 'hidden'} bg-white max-w-24 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
                        <div className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton2">
                            {/* Rating Filter */}
                            <h3 className="font-bold px-4 py-2">Rating</h3>
                            <ul>
                                    ...
                                    <li key={category}>
                                        <label className="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                            <input
                                                type="checkbox"
                                                className="mr-2"
                                                onChange={(e) => clickedFilter(category, e.target.checked)}
                                            />
                                            {category}
                                        </label>
                                    </li>
            ...
            {isLoading ? <div className="flex justify-center items-center h-64"><img className="w-24 h-24" src={loadingIcon} /></div> :
